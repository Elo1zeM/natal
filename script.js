...
async function loadProduct() {
  ...
  const mockProduct = [
    { name: 'Árvore de Natal', old_price: 1899, new_price: 879.4, emoji: '🌲' },
    { name: 'Celular', old_price: 7299, new_price: 3649.5, emoji: '📱' },
    { name: 'Bicicleta Vermelha', old_price: 899, new_price: 399, emoji: '🚴' },
    { name: 'Chocotone Importado', old_price: 299, new_price: 149.9, emoji: '🍫' },
    { name: 'Celular', old_price: 4899, new_price: 3599.9, emoji: '🎮' }
  ];
  ...
  // - A consulta usa `.from('product').select('*')` para pegar todos os campos
